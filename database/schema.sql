...
-- ALTER TABLE students MODIFY full_name VARCHAR(255) NOT NULL;
-- ALTER TABLE students MODIFY usn VARCHAR(50) NOT NULL;
-- ALTER TABLE students MODIFY branch VARCHAR(100) NOT NULL;
-- ALTER TABLE students MODIFY passing_year INT NOT NULL;
-- describe students;
